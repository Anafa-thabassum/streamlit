...
<style>
:root {
  --app-bg:#f5f7f8; --surface:#ffffff; --surface-soft:#eefaf8;
  --ink:#152238; --muted:#526075; --border:#d9e2e7;
...
[data-testid="stSidebar"] { background: #101d2d; }
...
.hero { padding:1.45rem 1.6rem; border:1px solid var(--border); border-radius:20px; background:linear-gradient(135deg,var(--surface) 0%,var(--surface-soft) 100%); margin-bottom:1.1rem; box-shadow:0 8px 28px rgba(0,0,0,.14); }
...
.stButton>button, .stDownloadButton>button {
  ...
  border:1px solid var(--border) !important; font-weight:700;
}
...
if page == "Home":
    ...
    step1.info("**1 · Upload**\n\nChoose your completed Excel sheet.")
    step2.info("**2 · Fetch**\n\nClick once to collect public statistics.")
    step3.info("**3 · Export**\n\nDownload the populated Excel report.")
